...
### Changed
- Updated Claude agent runtime to `@anthropic-ai/claude-agent-sdk` [v0.3.185](https://github.com/anthropics/claude-agent-sdk-typescript/blob/main/CHANGELOG.md) and `@anthropic-ai/sdk` v0.105.0. Tool list refreshed: `DesignSync` added, `TeamCreate`/`TeamDelete` removed. ([CYPACK-1345](https://linear.app/ceedar/issue/CYPACK-1345), [#1341](https://github.com/cyrusagents/cyrus/pull/1341))
